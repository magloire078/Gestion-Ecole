...
function StudentSheetContent({ eleveId, schoolId, schoolData }: { eleveId: string, schoolId: string, schoolData: any }) {
...
function StudentSheetClientInner() {
...
export default function StudentSheetClient() {
    return (
        <Suspense fallback={<StudentSheetPageSkeleton />}>
            <StudentSheetClientInner />
        </Suspense>
    );
}

...
function StudentTimetableContent({ eleveId, schoolId, schoolName }: { eleveId: string, schoolId: string, schoolName: string | undefined }) {
...
function StudentTimetableClientInner() {
...
export default function StudentTimetableClient() {
    return (
        <Suspense fallback={<StudentTimetablePageSkeleton />}>
            <StudentTimetableClientInner />
        </Suspense>
    );
}

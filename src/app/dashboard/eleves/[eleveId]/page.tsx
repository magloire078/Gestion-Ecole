                ...
                <Tabs defaultValue="grades">
                    ...
                    <TabsContent value="documents">
                         <Card>
                            ...
                            <CardContent className="space-y-4">
                                <Button onClick={() => router.push(`/dashboard/eleves/${studentId}/bulletin`)} className="w-full justify-start">
                                    <FileText className="mr-2 h-4 w-4" />
                                    Générer le Bulletin de Notes
                                </Button>
                                <Button onClick={() => router.push(`/dashboard/eleves/${studentId}/emploi-du-temps`)} className="w-full justify-start">
                                    <CalendarDays className="mr-2 h-4 w-4" />
                                    Voir l'Emploi du Temps
                                </Button>
                                <Button onClick={() => router.push(`/dashboard/eleves/${studentId}/fiche`)} className="w-full justify-start">

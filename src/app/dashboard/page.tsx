  ...
  useEffect(() => {
    ...
    const fetchAllData = async () => {
      ...
      try {
        ...
        // Vérifiez si ces collections existent
        ...
        // Bibliothèque - peut ne pas exister
        let totalBooks = 0;
        try {
        ...
        // Comptabilité - peut ne pas exister
        ...
        try {
          ...
          studentsActivitySnapshot.forEach(doc => {
            ...
            const createdAtSource = student.createdAt;
            const createdAt = createdAtSource 
              ? ('seconds' in createdAtSource ? new Date(createdAtSource.seconds * 1000) : new Date(createdAtSource))
              : new Date();
        ...
        try {
          ...
          messagesActivitySnapshot.forEach(doc => {
            ...
            const createdAtSource = message.createdAt;
            const createdAt = createdAtSource 
              ? ('seconds' in createdAtSource ? new Date(createdAtSource.seconds * 1000) : new Date(createdAtSource))
              : new Date();

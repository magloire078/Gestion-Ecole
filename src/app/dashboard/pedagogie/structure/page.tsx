...
export default function StructurePage() {
  ...
  return (
    <div className="p-4 md:p-6 space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="bg-white/40 dark:bg-slate-900/40 backdrop-blur-md border border-white/40 dark:border-slate-800/40 p-2 rounded-xl shadow-sm">
        <Tabs defaultValue="classes" className="w-full">
          <TabsList className="grid w-full grid-cols-3 bg-transparent p-1 h-auto gap-2">
            <TabsTrigger 
              value="classes" 
              className="rounded-xl py-3 data-[state=active]:bg-white dark:data-[state=active]:bg-slate-800 data-[state=active]:shadow-lg data-[state=active]:text-primary transition-all duration-300 font-bold"
            >
          ...
          <div className="px-2 pb-2">
            <TabsContent value="classes" className="mt-4 focus-visible:ring-0">
              <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-white/40 dark:border-slate-800/40 rounded-xl overflow-hidden shadow-sm">

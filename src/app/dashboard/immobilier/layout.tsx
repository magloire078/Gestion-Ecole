...
export default function ImmobilierLayout({
    ...
    const hasAccess = subscription?.plan === 'Premium' || subscription?.activeModules?.includes('immobilier');
        ...
        return (
            <div className="flex flex-col items-center justify-center h-[calc(100vh-200px)] text-center p-4 md:p-6">
                <Card className="max-w-lg">
                    ...
                    <CardContent>
                        <p className="text-muted-foreground">
                            La gestion immobilière (inventaire, maintenance, réservations) est un module complémentaire. Pour y accéder, veuillez l&apos;activer depuis la page d&apos;abonnement.
                        </p>
                    </CardContent>
                    <CardFooter>

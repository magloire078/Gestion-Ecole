    ...
    <AuthGuard>
      <TooltipProvider>
        <div className={cn("flex min-h-screen w-full flex-col bg-muted/40 print:bg-white")}>
          ...
          {/* Sidebar Desktop */}
          <aside className={cn(
            "fixed inset-y-0 left-0 z-40 hidden flex-col border-r bg-sidebar text-sidebar-foreground shadow-xl transition-all duration-300 ease-in-out sm:flex print:hidden",
            ...
            <header className={cn(
              ...
              <div className="flex items-center gap-3">
                <Sheet>
                  ...
                  <SheetContent side="left" className="w-full max-w-xs p-0 bg-sidebar text-sidebar-foreground border-r-0">
                    <MobileNav />
                  </SheetContent>
                </Sheet>

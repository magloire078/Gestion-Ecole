...
export function SubjectsManager() {
  ...
  const handleDelete = async () => {
    ...
    try {
      await SubjectsService.deleteSubject(schoolId, itemToDelete.id);
      toast({ title: 'Matière supprimée' });
    } catch (e) {
      console.error("Error deleting subject:", e);
      toast({ variant: "destructive", title: "Erreur de suppression", description: "Impossible de supprimer cette matière." });
    } finally {

...
import { LayoutDashboard, Users, BookUser, Wallet, Settings, CalendarClock, NotebookText, Landmark, UserPlus, ClipboardUser, School, FolderCog, GraduationCap, BookOpen } from 'lucide-react';

...
Ce guide vous accompagne pour mettre en ligne l'application sur `www.gerecole.com` et configurer l'environnement de production.
...
5. **Variables d'environnement** :
   ...
   - `NEXT_PUBLIC_BASE_URL` (ex: `https://www.gerecole.com`)
...
2. Allez dans la gestion de domaine pour `gerecole.com`.
...
1. Faites une requête POST vers `/api/seed` pour générer les données de démo.
   ...
   - Exemple curl : `curl -X POST https://www.gerecole.com/api/seed`
